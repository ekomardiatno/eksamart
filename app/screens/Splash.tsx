  ...
  render() {
            ...
            <View style={{ padding: 20, width: width }}>
              ...
              >
                <Text style={{ fontFamily: 'RobotoCondensed' }}>
                  Pembaruan aplikasi tersedia. Segera perbarui untuk tetap bisa
    ...
    return (
      ...
      >
        ...
        <Animated.Image
          style={{ width: 300, height: 300, opacity: fadeIn }}
          source={require('../assets/images/EKSAMART.png')}
        />
        <Update />
      </View>
    );
...
export default withSafeAreaInsets<Omit<Props, 'insets'>>(Splash);
