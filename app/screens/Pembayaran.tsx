...
import { Produk, KeranjangItem, Penjualan, Transaksi } from '../types'
import styles from '../components/styles'

interface Props {
  navigation: NativeStackNavigationProp<RootStackParamList, 'Pembayaran'>;
  route: RouteProp<RootStackParamList, 'Pembayaran'>;
  insets: EdgeInsets;
}
...
class Pembayaran extends Component<Props, State> {
        ...
        <ScrollView>
          <View style={{ padding: 15, paddingHorizontal: 20, backgroundColor: '#fff' }}>
            <View style={styles.formGroup}>
              ...
              <TextInput keyboardType="numeric" onChangeText={(bayar_str: string) => {
                const bayar = parseInt(bayar_str.replace(/,/g, ''))
                this.setState({
                  bayar,
...
export default withSafeAreaInsets<Omit<Props, 'insets'>>(Pembayaran)
